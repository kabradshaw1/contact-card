...
export const getDb = async () => {
  ...
  // Create a new transaction and speicify the store and data privileges.
...
export const deleteDb = async (id) => {
  ...
  // Create a connection to the Indexed database and the version we want to use.
  const contactDb = await openDB('contact_db', 1);

  // Create a new transation and specify the store and data privileges.
  const tx = contactDb.transaction('contacts', 'readwrite');
